...
#define flipDisplay true // TO FLIP THE DISPLAY ORIENTATION, JUST CHANGE THIS TO true
...
#define udefSSID "iPhone (48)" // user defined configuration AP name (not evil twin AP name)
#define udefPW "Heltec!"       // user defined configuration AP password (not evil twin AP password)
...
extern "C" { //TODO: delete this & verify it doesnt do anything
}
...
void handleResult() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    WiFi.softAPConfig(IPAddress(192, 168, 4, 1) , IPAddress(192, 168, 4, 1) , IPAddress(255, 255, 255, 0));
    WiFi.softAP("Wifi-Pentest", "wif12345"); // TODO: THEORETICALLY i dont think i need this 2nd declaration. try deleting it?
    dnsServer.start(53, "*", IPAddress(192, 168, 4, 1));
...
void handleIndex() {
  ...
  if (webServer.hasArg("hotspot")) {
    if (webServer.arg("hotspot") == "start") {
      ...
      Serial.println(String(n));
      WiFi.softAPConfig(IPAddress(192, 168, 4, 1) , IPAddress(192, 168, 4, 1) , IPAddress(255, 255, 255, 0));
      WiFi.softAP("Wifi-Pentest", "wif12345"); // TODO: fuck theres -3- 2 of them and idk why
      dnsServer.start(53, "*", IPAddress(192, 168, 4, 1));
    }
    return;
  }
...
void loop() {
  ...
  delay(1000);
      ...
      Serial.println("WIFI FAILURE"); // TODO: wtf?
    } else {
